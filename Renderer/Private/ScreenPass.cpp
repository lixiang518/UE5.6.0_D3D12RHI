...
FRDGTextureRef TryCreateRuntimeSceneViewTexture(FRDGBuilder& GraphBuilder, const FRuntimeSceneView& RuntimeSceneView)
{
	FRHITexture* TextureRHI = RuntimeSceneView.RenderTarget->GetRenderTargetTexture();
	FRDGTextureRef Texture = nullptr;
	if (TextureRHI)
	{
		Texture = RegisterExternalTexture(GraphBuilder, TextureRHI, TEXT("ViewFamilyTexture"));
