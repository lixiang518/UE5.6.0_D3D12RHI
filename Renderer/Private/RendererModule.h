...
public:
	...
	virtual void BeginRenderingViewFamily(FCanvas* Canvas,FSceneViewFamily* ViewFamily,FRuntimeSceneView* RuntimeSceneView) override;
	...
	virtual void BeginRenderingRuntimeViewScene(FCanvas* Canvas,TConstArrayView<FSceneViewFamily*> ViewFamilies, TConstArrayView<FRuntimeSceneView*> RuntimeSceneView);
